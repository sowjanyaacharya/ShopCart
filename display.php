...
<?php //display.php is used to display all the products which are there in he database it works for products button on the navbar
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="./users_area/userregister.php">Register</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex" role="search"> <!--d-flex means display flex which is used to display the in the horizontal row-->
                            ...
                            <div class="col-md-2 bg-secondary p-0 ">
                              ...
                              <ul class="navbar-nav me-auto text-center">
                               ...
                               getbrands();
                                ...
                                <!-- <li class="nav-item">
                                  <a href="#" class="nav-link text-light"><h6>Brand2</h6></a>
                                </li>
                                <li class="nav-item">
                                  <a href="#" class="nav-link text-light"><h6>Brand3</h6></a>
                                </li>
                                <li class="nav-item">
                                  <a href="#" class="nav-link text-light"><h6>Brand4</h6></a>
                                </li>
                                <li class="nav-item">
                                  <a href="#" class="nav-link text-light"><h6>Brand5</h6></a>
                                </li> -->
                              </ul>
