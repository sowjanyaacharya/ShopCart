...
<?php  //this page is used to serach the product using the products_keyword
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#"><i class="fa-solid fa-cart-arrow-down" ><sup><?php cartno(); ?></sup></i></a><!--fa solid maens color become bold-->
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">TotalPrice:<?php totalcartprice();?>/-</a>
        </li>
      </ul>
      <form class="d-flex" role="search" action="" method ="get"> <!--d-flex means display flex which is used to display the in the horizontal row-->
